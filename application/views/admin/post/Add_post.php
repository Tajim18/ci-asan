            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        ...
                        <label for="exampleSelectGender">Category_id</label>
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Enter Url" name="titleurl">  
                         </div>
								
								<div class="mb-3 col-xl-6">
                              <label for="name" class="form-label">Post URL</label>
                             <input type="text" class="form-control" id="name" placeholder="Enter Url" name="posturl"> 
                                </div>
